...
def init_simulation(params, filters, variables, save_sfh, create_table, flag_background,
                    ...
                    exptime, SNR, S_line, spectra, fluxes, info, t_begin, n_computed):
...
def simulation(idx):
    ...
    Dec = sed.info['Dec']
    RA = sed.info['RA']
    redshift2 = sed.info['z']
    print('RA, DEc, z', idx, RA, Dec, redshift2, '\n')
...
#
    ...
    for i_T_tel, T_tel_i in enumerate(T_tel):
        ...
        # Warning: we lose accuracy by taking 256*int(data/256)
        #data = data/256.*max_data
